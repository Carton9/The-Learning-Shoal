...
from examples.battle_model.algo import tools2 as tools
from examples.battle_model.senario_fishschool import battle
...
if __name__ == '__main__':
    ...
    main_model_dir = os.path.join(BASE_DIR, 'data/models/fishschool/{}-0'.format(args.algo))
    oppo_model_dir = os.path.join(BASE_DIR, 'data/models/fishschool/{}-1'.format(args.oppo))
    ...
    runner = tools.Runner(sess, env, handles, args.map_size, args.max_steps, models, battle, render_every=5)
