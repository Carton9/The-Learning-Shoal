...
public:
    ...
    float speed;
    // Yuanshan Lin
    int action_type;  // 0: dx, dy; 1: discrectized angular speed; 2: continuous angular speed; 3: continuous linear and angular speed
    float move_angle;
    int move_n;
    float hp;
    ...
    std::string name;
    int n_channel; // obstacle, group1, group_hp1, group_orientation1, group2, group_hp2, group_orientation2
