...
int env_set_agent_rand_pos(EnvHandle game, GroupHandle group, int idx){
    LOG(TRACE) << "env set agent random position.  ";
    ((::magent::gridworld::GridWorld *)game)->set_agent_rand_pos(group, idx);
    return 0;
}
